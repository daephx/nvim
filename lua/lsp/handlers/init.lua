...
-- vim.lsp.handlers['textDocument/rename'] = require('lsp.handlers.rename').incremental_rename
-- vim.lsp.handlers['textDocument/rename'] = vim.lsp.buf.rename.float

vim.lsp.handlers['textDocument/definition'] = require('lsp.handlers.definition').goto_definition()
